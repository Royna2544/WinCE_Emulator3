...
- Direct `FSDMGR_AdvertiseInterface @2` is covered for the current CE coredll-wrapper fail-closed path; real device-interface advertisement publication remains open.
