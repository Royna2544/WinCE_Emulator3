...
- Direct CE `fsdmgr.dll` path imports `@54`-`@67` are now covered for mounted create/remove directory, attributes, delete, move, delete-and-rename, disk-free-space, find-first, create-file, and system-file behavior; remaining direct path-import risk is limited to the security-manager exports and broader ACL persistence/enforcement.
