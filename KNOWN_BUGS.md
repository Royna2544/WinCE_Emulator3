...
- Direct CE `fsdmgr.dll` path imports `@54`-`@61` are now covered for mounted create/remove directory, attributes, delete, move, and delete-and-rename behavior; remaining direct path-import risk is disk-free-space, find/create-file forwarding, `FS_IsSystemFileW`, and security-manager exports.
