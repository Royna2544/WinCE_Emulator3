...
- File-handle `IOCTL_FILE_READ_SCATTER`/`IOCTL_FILE_WRITE_GATHER` are covered for synchronous page-multiple current-position transfers; CE reserved offset-array and overlapped scatter/gather behavior remains open.
