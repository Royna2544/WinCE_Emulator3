use wince_emulation_v3::{
    ...
    ce::{
        ...
        coredll_ordinals::{
            ...
            ORD_GET_FOCUS, ORD_GET_FOREGROUND_WINDOW, ORD_GET_KEY_STATE, ORD_GET_MENU,
            ...
            ORD_GET_PALETTE_ENTRIES, ORD_GET_PARENT, ORD_GET_QUEUE_STATUS, ORD_GET_RGN_BOX,
            ...
            ORD_GET_WINDOW_TEXT_W, ORD_GET_WINDOW_THREAD_PROCESS_ID, ORD_GLOBAL_MEMORY_STATUS,
            ORD_IN_SEND_MESSAGE, ORD_INFLATE_RECT, ORD_INSERT_MENU_W, ORD_INTERSECT_RECT,
            ...
            ORD_PT_IN_RECT, ORD_PT_IN_REGION, ORD_REALIZE_PALETTE, ORD_RECT_IN_REGION,
        ...
        gwe::{
            ...
            SWP_NOMOVE, SWP_NOSIZE, SWP_NOZORDER, SWP_SHOWWINDOW, VK_SHIFT, WA_ACTIVE, WA_INACTIVE,
...
fn coredll_raw_is_dialog_message_tabs_to_next_dialog_item() -> Result<()> {
    ...
    assert!(kernel.post_message_w_for_thread(thread_id, first, WM_KEYDOWN, VK_SHIFT, 0));
    assert!(matches!(
        table.dispatch_raw_ordinal_with_memory(
            &mut kernel,
            &mut memory,
    ...
    assert!(kernel.post_message_w_for_thread(thread_id, first, WM_KEYUP, VK_SHIFT, 0));
    assert!(matches!(
        table.dispatch_raw_ordinal_with_memory(
            &mut kernel,
            &mut memory,
