...
- Runtime loader work has reached dynamic Unicorn DLL mapping with dependency loading, import patching, forwarders, malformed-forwarder rejection, failed-load rollback for newly loaded modules, trampoline tracking, datafile/no-resolve flags, datafile export suppression, and lifecycle calls.
