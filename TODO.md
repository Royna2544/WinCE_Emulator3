...
- Expand `DrawIconEx`, `ImageList_DrawEx`, and `ImageList_DrawIndirect` tests for remaining mask, palette/dither blend, overlay handling, stretched draws, framebuffer output, and invalid object lifetimes.
