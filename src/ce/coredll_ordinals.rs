...
pub const SUPPLEMENTAL_ORDINALS: &[CoredllOrdinalDef; 131] = &[
    ...
    CoredllOrdinalDef {
        ...
        ordinal: ORD_IS_NAMED_EVENT_SIGNALED,
    },
    CoredllOrdinalDef {
    ...
    CoredllOrdinalDef {
        ...
        ordinal: ORD_DEBUG_ACTIVE_PROCESS_STOP,
    },
    CoredllOrdinalDef {
    ...
    CoredllOrdinalDef {
        ...
        ordinal: ORD_GET_DEVICE_INFORMATION_BY_DEVICE_HANDLE,
    },
    CoredllOrdinalDef {
    ...
    CoredllOrdinalDef {
        ...
        ordinal: ORD_RESOURCE_MARK_AS_SHAREABLE,
    },
    CoredllOrdinalDef {
        name: "ResourceDestroyList",
        ordinal: ORD_RESOURCE_DESTROY_LIST,
    },
    CoredllOrdinalDef {
        name: "LockFileEx",
