...
pub enum CeMathCall {
    ...
    FloatToLongLong(f32),
    DoubleToLongLong(f64),
    FloatToUnsignedLongLong(f32),
    DoubleToUnsignedLongLong(f64),
    LongToFloat(i32),
    LongToDouble(i32),
...
impl CeMath {
    pub fn eval(&self, call: CeMathCall) -> CeMathValue {
        match call {
            ...
            CeMathCall::FloatToLongLong(value) => CeMathValue::I64(value as i64),
            CeMathCall::DoubleToLongLong(value) => CeMathValue::I64(value as i64),
            CeMathCall::FloatToUnsignedLongLong(value) => CeMathValue::U64(value as u64),
            CeMathCall::DoubleToUnsignedLongLong(value) => CeMathValue::U64(value as u64),
...
impl CeMathCall {
    pub fn export_name(&self) -> &'static str {
        match self {
            ...
            Self::FloatToLongLong(_) => "__f_to_ll",
            Self::DoubleToLongLong(_) => "__d_to_ll",
            Self::FloatToUnsignedLongLong(_) => "__f_to_ull",
            Self::DoubleToUnsignedLongLong(_) => "__d_to_ull",
